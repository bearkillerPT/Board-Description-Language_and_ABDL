...
public interface AbdlVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitExprArrayIndex(AbdlParser.ExprArrayIndexContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code ExprArrDecl}
	 * labeled alternative in {@link AbdlParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprArrDecl(AbdlParser.ExprArrDeclContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link AbdlParser#arrayDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArrayDecl(AbdlParser.ArrayDeclContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link AbdlParser#type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitType(AbdlParser.TypeContext ctx);
}